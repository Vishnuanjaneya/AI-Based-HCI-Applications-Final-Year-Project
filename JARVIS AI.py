...
if __name__ == "__main__":          # Before running the code make sure you have Internet Connection 
    ...
    while True:
        ...
        if "wake up" in query:
            wishings()
            speak("BOSS,What can I do for you!")
            while True:
                ...
                if "wikipedia" in query:
                    ...
                    speak('Kind request to the viewers please Support, So that you can also get me in your Desktop through the source code which is available in our Telegram Channel!')
                    ...
                    os.startfile('C:\\Windows\\System32\\paint.exe')      # Use the path of your file here
                    while True:
                    ...
                    songs=os.listdir('C:\\Users\\ADMIN\\Desktop\\Songs')       # Use the path of your file here
                    os.startfile(os.path.join('C:\\Users\\ADMIN\\Desktop\\Songs' ,songs[0]))        # Use the path of your file here
